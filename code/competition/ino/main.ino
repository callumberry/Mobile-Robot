...
int rsensor = 28; // Left Sensor on Analog Pin 2
int lsensor = 26; // Right Sensor on Analog Pin 1
...
int current_mode = AUTO_MODE; // Variable to store the current mode. Starts in idle mode
